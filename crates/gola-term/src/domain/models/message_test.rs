...
#[test]
fn it_executes_new() {
    let msg = Message::new(Author::Gola, "Hi there!");
    assert_eq!(msg.author, Author::Gola);
    assert_eq!(msg.author.to_string(), "Gola");
...
fn it_executes_new_with_type() {
    let msg = Message::new_with_type(Author::Gola, MessageType::Error, "It broke!");
    assert_eq!(msg.author, Author::Gola);
    assert_eq!(msg.author.to_string(), "Gola");
...
fn it_executes_append() {
    let mut msg = Message::new(Author::Gola, "Hi there!");
    msg.append(" It's me!");
...
fn it_executes_codeblocks() {
    let msg = Message::new(Author::Gola, codeblock_fixture());
